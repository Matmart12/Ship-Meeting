...
<head>
    ...
    <div class="divtab">
        <table width="90%" height="90%" align="center" margin-top="auto">
            ...
            <tr></tr>
            <tr height="110">
                <td> <?php if($index == $_SESSION['index'] || $grade == "admin")echo "Prénom: $prenom"?></td>                           <!-- seulement pour le propritétaire du compte--> 
                <td> <?php if($index == $_SESSION['index'] || $grade == "admin")echo "Nom: $nom"?></td>                              <!-- seulement pour le propritétaire du compte--> 
                
            </tr>
            <tr>
                <td> <?php if($index == $_SESSION['index'] || $grade == "admin")echo "mot de passe: $password" ?></td>    <!-- seulement pour le propritétaire du compte--> 
                <td> <?php if($index == $_SESSION['index'] || $grade == "admin")echo "Mail: $email" ?></td>            <!-- seulement pour le propritétaire du compte--> 
            </tr>
            <tr height="110">
